...
public class Tab1FragmentNewAdapter
        extends RecyclerView.Adapter<Tab1FragmentNewAdapter.FeedModelViewHolder> {

    private List<Tab1FragmentNew.RssFeedModelNew> mRssFeedModels;
    ...
    public Tab1FragmentNewAdapter(List<Tab1FragmentNew.RssFeedModelNew> rssFeedModels, Context context ) {
    ...
    public void onBindViewHolder(FeedModelViewHolder holder, int position) {
        final Tab1FragmentNew.RssFeedModelNew rssFeedModel = mRssFeedModels.get(position);
