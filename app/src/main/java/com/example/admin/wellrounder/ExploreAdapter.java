...
public class ExploreAdapter
        extends RecyclerView.Adapter<ExploreAdapter.FeedModelViewHolder> {

    private List<ExploreTab1.RssFeedModel> mRssFeedModels;
    ...
    public ExploreAdapter(List<ExploreTab1.RssFeedModel> rssFeedModels, Context context ) {
    ...
    public void onBindViewHolder(FeedModelViewHolder holder, int position) {
        final ExploreTab1.RssFeedModel rssFeedModel = mRssFeedModels.get(position);
