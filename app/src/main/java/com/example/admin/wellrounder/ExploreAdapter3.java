...
public class ExploreAdapter3
        extends RecyclerView.Adapter<ExploreAdapter3.FeedModelViewHolder> {

    private List<ExploreTab3.RssFeedModel> mRssFeedModels;
    ...
    public ExploreAdapter3(List<ExploreTab3.RssFeedModel> rssFeedModels, Context context ) {
    ...
    public void onBindViewHolder(FeedModelViewHolder holder, int position) {
        final ExploreTab3.RssFeedModel rssFeedModel = mRssFeedModels.get(position);
