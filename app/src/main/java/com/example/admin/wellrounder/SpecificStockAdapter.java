...
public class SpecificStockAdapter
        extends RecyclerView.Adapter<SpecificStockAdapter.FeedModelViewHolder> {

    private List<SpecificStockItem.RssFeedModel> mRssFeedModels;
    ...
    public SpecificStockAdapter(List<SpecificStockItem.RssFeedModel> rssFeedModels, Context context ) {
    ...
    public void onBindViewHolder(FeedModelViewHolder holder, int position) {
        final SpecificStockItem.RssFeedModel rssFeedModel = mRssFeedModels.get(position);
