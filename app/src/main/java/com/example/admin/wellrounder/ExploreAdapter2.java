...
public class ExploreAdapter2
        extends RecyclerView.Adapter<ExploreAdapter2.FeedModelViewHolder> {

    private List<ExploreTab2.RssFeedModel> mRssFeedModels;
    ...
    public ExploreAdapter2(List<ExploreTab2.RssFeedModel> rssFeedModels, Context context ) {
    ...
    public void onBindViewHolder(FeedModelViewHolder holder, int position) {
        final ExploreTab2.RssFeedModel rssFeedModel = mRssFeedModels.get(position);
